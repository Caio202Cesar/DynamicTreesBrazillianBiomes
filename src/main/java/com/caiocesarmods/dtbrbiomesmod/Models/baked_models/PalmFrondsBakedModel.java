...
public class PalmFrondsBakedModel implements IDynamicBakedModel {
    public static List<PalmFrondsBakedModel> INSTANCES = new ArrayList<>();
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        int direction = state.get(PalmLeavesProperties.DynamicPalmLeavesBlock.DIRECTION);
