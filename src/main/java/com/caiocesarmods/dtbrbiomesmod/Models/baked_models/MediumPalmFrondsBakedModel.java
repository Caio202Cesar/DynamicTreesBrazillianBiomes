...
public class MediumPalmFrondsBakedModel implements IDynamicBakedModel {

    public static List<MediumPalmFrondsBakedModel> INSTANCES = new ArrayList<>();
    ...
    public MediumPalmFrondsBakedModel(ResourceLocation modelResLoc, ResourceLocation frondsResLoc){
