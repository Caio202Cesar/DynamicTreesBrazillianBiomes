...
public class PalmFrondsModelLoader implements IModelLoader<PalmFrondsModelGeometry> {
    ...
    @Override
    public PalmFrondsModelGeometry read(JsonDeserializationContext deserializationContext, JsonObject modelObject) {
        final JsonObject textures = this.getTexturesObject(modelObject);
        return new PalmFrondsModelGeometry(getTextureLocation(textures, FROND));
    }
