...
public class PodocarpusFamily extends Family {

    public static final TypedRegistry.EntryType<Family> TYPE = TypedRegistry.newType(PodocarpusFamily::new);

    public PodocarpusFamily(ResourceLocation name) {
        super(name);
    }
