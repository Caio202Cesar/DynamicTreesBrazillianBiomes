...
public class KapokFamily extends Family {

    public static final TypedRegistry.EntryType<Family> TYPE = TypedRegistry.newType(KapokFamily::new);

    public KapokFamily(ResourceLocation name) {
        super(name);
    }
