...
public class CashewFamily extends Family {

    public static final TypedRegistry.EntryType<Family> TYPE = TypedRegistry.newType(CashewFamily::new);

    public CashewFamily(ResourceLocation name) {
        super(name);
    }
